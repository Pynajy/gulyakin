...
from market.models import Adress
...
class TelegaramBotForAdressMarket(models.Model):
    adress = models.ForeignKey(Adress, on_delete=models.CASCADE, verbose_name="Адрес")
    main_bot = models.BooleanField(default=True, verbose_name="Основной бот?")
    token = models.CharField(max_length=500, blank=True, verbose_name="Ключ от бота")
    chanel = models.CharField(max_length=100, verbose_name="Чат")

    def __str__(self) -> str:
        return f'{self.adress}'
    
    class Meta:
        verbose_name_plural = 'Телеграмм чаты адресов'
